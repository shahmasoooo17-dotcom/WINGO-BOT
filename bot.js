// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// ENTERPRISE UNIFIED TRADING BOT v3.3 - PAKISTAN WINGO STANDARD EDITION
...
function getPKTTime() {
    const now = new Date();
    // Normalize system clock to absolute UTC, then append the Pakistan standard offset (+5 Hours)
...
function getCurrentPeriod30s() {
    ...
    // Total elapsed seconds in the current day split into 30-second slots (1 to 2880)
    const totalSeconds = (pkt.getHours() * 3600) + (pkt.getMinutes() * 60) + pkt.getSeconds();
    const slot = Math.floor(totalSeconds / 30) + 1;
    
    // Outputs 14-digit layout standard: YYYYMMDD + 30 + XXXX
...
function getCurrentPeriod1m() {
    ...
    // Total elapsed minutes in the current day (1 to 1440)
    const slot = (pkt.getHours() * 60) + pkt.getMinutes() + 1;
    
    // Outputs 14-digit layout standard: YYYYMMDD + 01 + XXXX
...
bot.on('callback_query', async (query) => {
    ...
    if (data.startsWith('wmenu:')) {
        ...
        // Base auto periods directly from customized local functions matching standard games
